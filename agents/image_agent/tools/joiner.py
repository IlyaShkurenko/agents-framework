...
class AssistantResponse(BaseModel):
    ...
    message: Optional[str] = Field(None, description="Assistant message")
...
class Joiner(BaseComponent):
    """
    Tool that combines image and approve message into one json object.
    """
    ...
    def description(self):
        return "Tool for returning image along with message. Must always be the last tool in the plan."
